...
#DoD out paths
DoD_Dec16_Jan18_NL = os.path.join(out_ras_home, "DoD_Dec16_Jan18_noLoD.tif")
DoD_Sep17_Sep18_NL = os.path.join(out_ras_home, "DoD_Sep17_Sep18_noLoD.tif")
...
def dod_no_lod():
    ...
    pcplot.plot_dem_of_diff(Sep17_Sep18.ras_out_path, v_range=(-5, 5), title="Sep 2017 - Sep 2018",
                            ...
                            gdf_cmap=beaver_z_cmap, gdf_legend=False, cmap='coolwarm_r', method='basic')

    plt.show()

    fig.savefig(fname='C:/HG_Projects/CWC_Drone_work/maps/DEMofDiff_NoLoD.jpg', dpi=300, format='jpg')
