...
# Set project (tested with psz, but should also work with psx).
# filename = os.path.abspath("C:/HG_Projects/CWC_Drone_work/17_02_15_Danes_Mill/17_02_15_DanesCroft.psz")
filename = os.path.abspath("C:/workspace/20180602_MV_SGB/20180602_MV_SGB.psz")
...
def main():
    ...
    chunk.marker_projection_accuracy = tiepoint_acc  # This is what the PDF accompanying Mike's origional code, but we want to double check.
    doc.save()
