...
for i in [dpc1_path, dpc2_path, dpc3_path, dpc4_path, dpc5_path, dpc6_path,
          pcp1_path, pcp2_path, pcp3_path, pcp4_path, pcp5_path, pcp6_path, dtm_path, mask_shp]:
...
def main():
    ...
    for x in [dsm1, dsm2, dsm3, dsm4, dsm5, dsm6]:
    ...
    for x in [chm1, chm2, chm3, chm4, chm5, chm6]:
    ...
    for x in [prras1, prras2, prras3, prras4, prras5, prras6]:
